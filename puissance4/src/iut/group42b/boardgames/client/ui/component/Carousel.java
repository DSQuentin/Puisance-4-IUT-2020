...
public class Carousel extends AnchorPane {
	...
	private final List<ImageView> slides;
	...
	public void start() {
		...
		for (ImageView slide : this.slides) {

			SequentialTransition sequentialTransition = new SequentialTransition();

			FadeTransition fadeIn = this.getFadeTransition(slide, 0.0, 1.0, 1000);
			PauseTransition stayOn = new PauseTransition(Duration.millis(4000));
			FadeTransition fadeOut = this.getFadeTransition(slide, 1.0, 0.0, 1000);
